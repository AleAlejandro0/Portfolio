 ...
 return (
   <div className='skills' style={{ display: skillSection }} data-scroll-section>
     ...
     <ul className='skills_container'>
       <li className='skills_item'><i className="icon_skill fa-brands fa-react"></i>React.JS</li>
       ...
       <li className='skills_item'><i className="icon_skill fa-brands fa-node"></i>Node.JS</li>
       <li className='skills_item'><i className="icon_skill fa-solid fa-language"></i>English B1</li>
